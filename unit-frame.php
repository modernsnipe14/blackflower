<?php
  ...
  if (isset($_POST["addunit"])) {
    ...
    MysqlQuery($query) or die ("couldn't insert unit: ".mysql_error());
...
<?php
  ...
  foreach ($types as $type) {
    ...
    $unitresult = MysqlQuery($unitquery) or die("unit Query failed : ".mysql_error());
...
/////////////////////////////////////////////////////
      ...
      foreach ($unitnames as $u_name) {
        ...
        $oidresult = MysqlQuery($oidquery) or die("In query: $oidquery\nError: " . mysql_error());
